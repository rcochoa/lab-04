...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("rcochoa/ipinfo")
    client.subscribe("rcochoa/date")
    client.subscribe("rcochoa/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("rcochoa/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("rcochoa/date", on_message_from_date)
    client.message_callback_add("rcochoa/time", on_message_from_time)
